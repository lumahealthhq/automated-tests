...
When I change context to element located `xpath(//*[contains(text(),'Hi ${firstName}, this is')])`
Then the text 'Hi ${firstName}, this is ${facilityNameVariable1}. We're sorry you were unable to make your appointment yesterday on ${dateVariable}. If you haven't already, please call ${facilityPhoneVariable1} to reschedule' exists
