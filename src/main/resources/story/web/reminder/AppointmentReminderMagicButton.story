Description: Story performs verification of testcase "1.0 Appointment Reminder Magic Button" (TestCaseId=21)
Meta:
    @epic Sanity
    @feature Reminder
    @testCaseId 21
...
Scenario: Run magic button and verify patient recieves message (Step 3-4)
Meta:
    @severity 1
...
When I open URL `${appointmentReminderMagicButtonUrl}` in new window
...
Scenario: Reply 'YES' as patient (Step 5)
Meta:
    @severity 1
Given I request messages for patient with id '${patientId}' and access token '${accessToken}'
