...
When I wait until element located `xpath(//*[contains(text(), 'Review and book')]/parent::div/div/descendant::*[contains(text(), 'SEND APPOINTMENT REQUEST') or contains(text(), 'Submit Request')])` appears
...
Meta:
    @severity 1
When I click on element located `xpath(//*[contains(text(), 'Review and book')]/parent::div/div/descendant::*[contains(text(), 'SEND APPOINTMENT REQUEST') or contains(text(), 'Submit Request')])`
When I wait until element located `xpath(//*[contains(text(), 'Your appointment time is reserved') or contains(text(), 'Pending Appointment')])` appears
